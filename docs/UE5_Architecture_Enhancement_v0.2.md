...
class FUTUREWORLD_API UFWPrimaryDataAsset : public UPrimaryDataAsset
{
    GENERATED_BODY()

public:
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="FutureWorld|Content")
    FName ContentId;
...
```text
Source/FutureWorld/Progression
